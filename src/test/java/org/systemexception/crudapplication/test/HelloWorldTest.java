...
import org.systemexception.crudapplication.servlet.HelloWorld;
...
public class HelloWorldTest {
	...
	public void testServlet() throws Exception {
		...
		writer.flush();
		assertTrue(FileUtils.readFileToString(new File(fileName), "UTF-8").contains("Servlet HelloWorld"));
	}
}